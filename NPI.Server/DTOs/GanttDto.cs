...
namespace NPI.Server.DTOs
{
    ...
    {
        [Required(ErrorMessage = "Revision notes are required")]
        [StringLength(1000, ErrorMessage = "Revision notes cannot exceed 1000 characters")]
        public string revision_notes { get; set; }

        [Required(ErrorMessage = "Tasks are required for revision")]
