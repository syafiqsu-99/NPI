...
namespace NPI.Server.Migrations
{
    ...
    [Migration("20260723061519_NPI10")]
    partial class NPI10
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NPI.Server.Models.EnquiryReviews", b =>
                {
                    ...
                    b.HasIndex("enquiry_id", "created_at");

                    b.ToTable("EnquiryReviews");
                });

            modelBuilder.Entity("NPI.Server.Models.EnquiryRevisionSnapshots", b =>
                {
                    b.Property<int>("snapshot_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("snapshot_id"));
                    ...
                    b.Property<string>("field_values_json")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("enquiry_id", "revision_no")
                        .IsUnique()
                        .HasDatabaseName("IX_EnquiryRevSnap_Enquiry_Rev");

                    b.ToTable("EnquiryRevisionSnapshots");
                });
            ...
            modelBuilder.Entity("NPI.Server.Models.TaskComments", b =>
                {
            ...
            modelBuilder.Entity("NPI.Server.Models.EnquiryReviews", b =>
                {
                    ...
                    b.HasOne("NPI.Server.Models.Users", "ReviewedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("NPI.Server.Models.EnquiryRevisionSnapshots", b =>
                {
                    b.HasOne("NPI.Server.Models.Enquiries", "Enquiry")
                        .WithMany("RevisionSnapshots")
                        .HasForeignKey("enquiry_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NPI.Server.Models.Users", "SubmittedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("NPI.Server.Models.Enquiries", b =>
                {
                    ...
                    b.Navigation("RevisionSnapshots");
                });
